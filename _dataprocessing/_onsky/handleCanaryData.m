classdef handleCanaryData < handle
    ...
    methods
        ...
        function obj = handleCanaryData(date,path_data,path_im,path_calib,varargin)
            inputs = inputParser;
           ...
           %%
            ...
            header    = im_header.PrimaryData.Keywords;
            list      = header(:,1);
            val       = header(:,2);
            ...
            time_ncpa = '21h20m56s';
            obj.psf_ncpa  = fitsread([path_data,'/ir/ir_',psf_calib,'.fits']);
            %5.2 load the fil
